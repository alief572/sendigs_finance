<?php
$ENABLE_VIEW = has_permission('Approval_Pembelian_Asset_Management.View');
$ENABLE_ADD = has_permission('Approval_Pembelian_Asset_Management.Add');
$ENABLE_MANAGE = has_permission('Approval_Pembelian_Asset_Management.Manage');
$ENABLE_DELETE = has_permission('Approval_Pembelian_Asset_Management.Delete');
?>
...
<script>
    ...
    function DataTables(tanda = null) {
        var dataTable = $('#my-grid').DataTable({
            ...
            "ajax": {
                url: base_url + active_controller + 'server_side_asset_app_manage',
                type: "post",
                data: function(d) {
                    d.tanda = tanda
                },
