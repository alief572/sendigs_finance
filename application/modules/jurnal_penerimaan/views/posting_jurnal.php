    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <input type="text" name="debit" class="form-control form-control-sm text-right debit" value="<?= number_format($item->debit) ?>" onchange="hitungDebit();" readonly>
                </td>
                <td>
                    <input type="text" name="kredit" class="form-control form-control-sm text-right kredit" value="<?= number_format($item->kredit) ?>" onchange="hitungKredit();" readonly>
                </td>
            </tr>
        <?php
