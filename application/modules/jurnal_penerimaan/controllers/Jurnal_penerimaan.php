...
class Jurnal_penerimaan extends Admin_Controller
{
    ...
    public function save_posting_jurnal()
    {
        ...
        if ($get_jurnal->jenis_transaksi == 'Invoicing') {
            ...
            $Nomor_JV  = $this->Jurnal_penerimaan_nomor_model->get_Nomor_Jurnal_Sales('101', $get_jurnal->tgl_jurnal, $get_jurnal->id_company);
        ...
        if ($get_jurnal->jenis_transaksi == 'Payment') {
            ...
            $Nomor_JV = $this->Jurnal_penerimaan_nomor_model->get_no_buk('101', $get_jurnal->id_company);
