<?php
$ENABLE_ADD     = has_permission('Report_Jurnal_Payment.Add');
$ENABLE_MANAGE  = has_permission('Report_Jurnal_Payment.Manage');
$ENABLE_VIEW    = has_permission('Report_Jurnal_Payment.View');
$ENABLE_DELETE  = has_permission('Report_Jurnal_Payment.Delete');
?>
...
<style>
    ...
    #table_jurnal_payment thead th:first-child {
        border-top-left-radius: 6px;
    }

    #table_jurnal_payment thead th:last-child {
        border-top-right-radius: 6px;
    }

    #table_jurnal_payment tbody td {
        vertical-align: middle !important;
    ...
    #table_jurnal_payment tbody tr:hover {
...
<div class="box box-filter">
    <div class="box-body" style="padding: 20px;">
        <div class="filter-title">
            <i class="fa fa-sliders text-primary" style="margin-right: 6px;"></i> Filter Data Laporan
        </div>
        <div class="row">
...
<div class="box box-table">
    <div class="box-body" style="padding: 20px;">
        <div class="table-responsive">
            <table id="table_jurnal_payment" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
    ...
    <div class="modal-dialog modal-lg" style="width: 95%; max-width: 1200px;">
        <div class="modal-content" style="border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.2); border: none;">
            <div class="modal-header" style="background: linear-gradient(135deg, #0073b7 0%, #00a65a 100%); color: white; border-top-left-radius: 8px; border-top-right-radius: 8px; padding: 15px 20px;">
                ...
                <h4 class="modal-title" id="myModalLabel" style="font-weight: 600; letter-spacing: 0.5px;"><span class="fa fa-book" style="margin-right: 8px;"></span> View Jurnal Payment</h4>
            </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.view_jurnal', function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#myModalLabel').html('<span class="fa fa-book" style="margin-right: 8px;"></span> View Jurnal Payment - ' + no_transaksi);
            ...
            error: function(result) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error !',
                    text: 'Gagal memuat rincian data jurnal. Silakan coba beberapa saat lagi !',
    ...
    function DataTables(tgl_jurnal = null, no_transaksi = null, company = null) {
        $('#table_jurnal_payment').DataTable({
            ajax: {
    ...
    function export_jurnal() {
        ...
        window.open(siteurl + active_controller + 'export_excel?tgl_jurnal=' + encodeURIComponent(tgl_jurnal) + '&no_transaksi=' + encodeURIComponent(no_transaksi) + '&company=' + encodeURIComponent(company), '_blank');
    }
