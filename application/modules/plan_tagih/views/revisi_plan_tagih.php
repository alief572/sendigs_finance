...
<form action="" method="post" id="frm-data">
    <input type="hidden" name="id_header" value="<?= $data_plan_tagih_header->id ?>">
    <div class="box">
        ...
        <div class="box-body">
            ...
            <table class="table_client" style="width: 100%;" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="form-control form-control-sm" name="keterangan_penagihan"><?= $data_plan_tagih_header->keterangan_penagihan ?></textarea>
                    </td>
                    <th width="20%"></th>
                    <td></td>
                </tr>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    foreach ($data_top_spk_penawaran as $item) {
                        ...
                        $tgl_plan_tagih = (isset($arr_plan_tagih[$item->id])) ? $arr_plan_tagih[$item->id]['tgl_plan_tagih'] : '';
                        $id_plan_tagih = (isset($arr_plan_tagih[$item->id])) ? $arr_plan_tagih[$item->id]['id_plan_tagih'] : '';
                        ...
                        echo '<input type="hidden" name="dt[' . $no . '][id_plan_tagih]" value="' . $id_plan_tagih . '">';
                        echo '</td>';
                        echo '<td class="text-right">Rp. ' . number_format($item->nominal_payment, 2) . '</td>';
                        echo '<td class="text-left">' . $item->desc_payment . '</td>';
                        echo '<td class="text-left">';
                        echo '<input type="date" class="form-control form-control-sm" name="dt[' . $no . '][tgl_plan_tagih]" value="' . $tgl_plan_tagih . '" required>';
                        echo '</td>';
    ...
    $(document).on('submit', '#frm-data', function(e) {
        ...
        swal({
            ...
            if (next) {
                ...
                $.ajax({
                    type: 'post',
                    url: siteurl + active_controller + 'revisi_plan_tagih',
                    data: form_data,
                    cache: false,
                    dataType: 'json',
