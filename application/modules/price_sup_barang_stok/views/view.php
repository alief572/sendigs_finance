...
$nm_cat = !empty($header->nm_category) ? strtoupper($header->nm_category) : '-';
?>
...
<div class="row">
    <div class="col-md-6">
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                <th class="bg-gray">Kategori Stok</th>
                <td><b class="text-primary"><?= $nm_cat ?></b></td>
            </tr>
            <tr>
    ...
    <div class="col-md-6">
        <table class="table table-condensed table-bordered">
            ...
            <tr>
                ...
                <td>
                    <?php if (!empty($files)): ?>
                        <button type="button" class="btn btn-sm btn-primary btn-view-evidence" data-no_doc="<?= $header->no_doc ?? '' ?>">
...
<h4 style="margin-top:20px; font-weight:bold;"><i class="fa fa-list"></i> Rincian Barang yang Diajukan &mdash; <?= $nm_cat ?></h4>
...
<?php else: ?>
    <div class="panel panel-info" style="margin-bottom:15px;">
        <div class="panel-heading" style="font-weight:bold; padding: 6px 12px;">
            <i class="fa fa-tags"></i> KATEGORI: <?= $nm_cat ?> (<?= count($details) ?> item)
        </div>
            ...
            <table class="table table-bordered table-striped table-condensed" style="margin:0;">
                <thead>
                    <tr class="bg-gray">
                        ...
                        <th rowspan="2" class="text-center" width="28%">Nama Barang & Spesifikasi</th>
                        <th rowspan="2" class="text-center" width="8%">Satuan</th>
                        <th colspan="2" class="text-center bg-gray-active" width="24%">Harga Aktif (Before)</th>
                        <th colspan="2" class="text-center" style="background:#d9edf7;" width="24%">Harga Baru Diajukan (After)</th>
                        <th rowspan="2" class="text-center" width="10%">Expired</th>
                    </tr>
                    <tr class="bg-gray">
                        <th class="text-center">Lower IDR</th>
                        <th class="text-center">Higher IDR</th>
                        <th class="text-center" style="background:#d9edf7;">Lower IDR</th>
                        <th class="text-center" style="background:#d9edf7;">Higher IDR</th>
                    </tr>
                </thead>
                <tbody>
