...
class Report_jurnal_invoicing extends Admin_Controller
{
    protected $viewPermission     = 'Report_Jurnal_Invoicing.View';
    protected $addPermission      = 'Report_Jurnal_Invoicing.Add';
    protected $managePermission = 'Report_Jurnal_Invoicing.Manage';
    protected $deletePermission = 'Report_Jurnal_Invoicing.Delete';
    ...
    public function __construct()
    {
        ...
        $this->load->model(array(
            'Report_jurnal_invoicing/Report_jurnal_invoicing_model',
            'Report_jurnal_invoicing/Report_jurnal_invoicing_nomor_model'
        ));
    ...
    public function export_excel()
    {
        ...
        $get_data_jurnal = $this->Report_jurnal_invoicing_model->get_jurnal_invoicing($tgl_from, $tgl_to, $client, $company, $divisi);
    ...
    {
        $this->Report_jurnal_invoicing_model->get_data_jurnal_invoicing();
    }
}
