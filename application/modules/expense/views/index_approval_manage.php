...
<div class="box box-custom">
	<div class="box-custom-header">
		<h4 class="box-custom-title"><i class="fa fa-check-circle text-primary"></i> Daftar Approval Expense (Management)</h4>
	</div>
	<!-- /.box-header -->
...
<script type="text/javascript">
	...
	function datatables() {
		$('#mytabledata').dataTable({
			...
			ajax: {
				type: 'POST',
				url: siteurl + 'expense/get_dat_approval_expense_manage',
				cache: false,
				dataType: 'json',
