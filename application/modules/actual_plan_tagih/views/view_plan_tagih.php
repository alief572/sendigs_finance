        ...
        <div class="box-body">
            ...
            <table class="table_client" style="width: 100%;" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="form-control form-control-sm" name="keterangan_penagihan" readonly><?= $data_plan_tagih_header->keterangan_penagihan ?></textarea>
                    </td>
                    <th width="20%"></th>
                    <td></td>
                </tr>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    foreach ($data_top_spk_penawaran as $item) {
                        ...
                        echo '<input type="date" class="form-control form-control-sm" name="dt[' . $no . '][tgl_plan_tagih]" value="' . $tgl_plan_tagih . '" readonly>';
                        echo '</td>';
